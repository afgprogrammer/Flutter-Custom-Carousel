# Flutter Custom Carousel Application UI Design and Animation

Flutter Custom Carousel Application UI/UX design and Animation - day 18 Flutter Animation and UI Design.
This repository is a part of the 100-day design in Flutter.

In this video we use, Flutter Animation, Fade, Container, Gradient, LinearGradient and so on in the one-speed video.

[Youtube Video](https://youtu.be/tP7gx1NuphU)
